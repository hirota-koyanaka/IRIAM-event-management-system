      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
          <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 px-6 py-8 text-white text-center">
            ...
            <p className="text-xl font-semibold text-white drop-shadow-sm">開催概要ダッシュボード</p>
          </div>
                  ...
                  <div className="space-y-3">
                    ...
                    {project.locationMapUrl && (
                      <a
                        ...
                        className="inline-block bg-gradient-to-r from-indigo-500 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-medium hover:from-indigo-600 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105"
                      >
