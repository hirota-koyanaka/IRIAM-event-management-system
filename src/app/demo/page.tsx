      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-8 text-white text-center">
            <h1 className="text-3xl font-bold mb-3">IRIAM EVENT CALL SHEET デモ</h1>
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <p className="text-xl font-semibold text-white drop-shadow-sm">システム体験版</p>
              <div className="w-2 h-2 bg-white rounded-full"></div>
            </div>
            <p className="text-blue-100">実際のプロジェクト管理システムをお試しいただけます</p>
          </div>
          ...
          <div className="p-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800">
                      このデモは実際のIRIAM EVENT CALL SHEETプロジェクト管理システムの機能をご体験いただけます。
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gray-50/50 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
                ...
                <div className="mt-3 space-y-2">
                  ...
                  <p className="text-sm text-gray-600">開催日: {project.recordingDate}</p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 to-blue-500 text-white px-6 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-blue-600 transition-all duration-200 transform hover:scale-105 flex items-center justify-center gap-3"
                >
                ...
                <p className="text-sm text-gray-600 mt-2">
                  基本情報・出演者管理・企画管理・スケジュール管理など、すべての管理機能をお試しいただけます。
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {project.performers.map((performer) => (
                    <button
                      ...
                      className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-4 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/50 transition-all duration-200 hover:shadow-lg group"
                    >
                      <div className="text-center">
                        <div className="w-12 h-12 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:from-blue-500 group-hover:to-indigo-600 transition-all">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="bg-gradient-to-r from-indigo-50 to-sky-50 rounded-xl p-4 border border-purple-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-800">
                      実際のIRIAM EVENT CALL SHEETシステムでは、管理者機能・スケジュール管理・総合スケジュール管理など、
