    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/20">
          {/* ヘッダーセクション */}
          <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 px-4 py-12 text-white relative overflow-hidden">
            {/* 背景装飾 */}
          ...
          {/* 収録情報セクション */}
          <div className="bg-gradient-to-br from-indigo-50/80 to-blue-50/80 backdrop-blur-sm border-b border-indigo-100/50 p-8">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-700 bg-clip-text text-transparent mb-2">
                  開催情報
                </h2>
                <div className="w-16 h-1 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full mx-auto"></div>
              </div>
          ...
          <div className="p-6">
            ...
            {proposal.overview && (
              <div className="border-t border-gray-100 pt-6 mb-8">
                <h3 className="text-xl font-semibold bg-gradient-to-r from-indigo-600 to-indigo-700 bg-clip-text text-transparent mb-4">
                  企画概要
                </h3>
            ...
            {proposal.youtubeEmbedId && (
              <div className="border-t border-gray-100 pt-6 mb-8">
                <h3 className="text-xl font-semibold bg-gradient-to-r from-indigo-600 to-indigo-700 bg-clip-text text-transparent mb-4 flex items-center">
            ...
            {/* 出演条件 */}
            <div className="border-t border-gray-100 pt-6 mb-8">
              <h3 className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-indigo-600 to-indigo-700 bg-clip-text text-transparent mb-3">
                出演条件について
              </h3>
              <div className="bg-white/70 backdrop-blur-sm rounded-xl p-3 sm:p-4 border border-white/50 shadow-md">
                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-3 sm:p-4 border border-indigo-200 mb-3">
